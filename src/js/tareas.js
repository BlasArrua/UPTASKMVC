(function(){
    ...
    let filtradas = [];
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //boton para mostrar modal de agreagar tarea
    ...
    function mostrarTareas(){
        ...
        arrayTareas.forEach(tarea =>{
            ...
            nombreTarea.ondblclick = function(){mostrarFormulario(editar = true,{...tarea});}
    ...
    function mostrarAlerta(mensaje,tipo,referencia){
        //Prevenir creacion de multiples alertas
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //consultar el servidor para agregar tarea
    async function agregarTarea(tarea){
        //Construir peticion para comunicarse con TareaController
        ...
        try {
            ...
            Swal.fire('Tarea Creada!','Tarea Creada Correctamente','success');
            if(resultado.tipo === 'exito'){
                ...
                filtrarTareas({ target: document.querySelector('input[type="radio"]:checked') });
                mostrarTareas();
            }
